 ...
 * @param <M> Class implementing {@link ClusteringModel}
 */
public abstract class ClusteringController<M extends ClusteringModel>
        extends AbstractController<M, Clustering> implements GroupingSupportable<Cluster> {

    public void setClustering(Clustering cl) {
        setModelData(cl);
    }
