...
import org.mongkie.vm.ranking.transformer.LabelColorTransformerBuilder.LabelColorTransformer;
...
public class LabelColorTransformerUI extends AbstractTransformerUI<ColorTransformerPanel> {

    @Override
    public Icon getIcon() {
        return new ImageIcon(getClass().getResource("/org/mongkie/ui/vm/resources/font_color.png"));
    }
