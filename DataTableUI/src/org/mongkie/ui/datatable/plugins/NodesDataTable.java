 ...
 */
package org.mongkie.ui.datatable.plugins;
...
public class NodesDataTable extends AbstractDataTable {
    ...
    protected String getLabelColumn(MongkieDisplay d) {
        return d.getGraph().getNodeLabelField();
    }
    ...
    public Icon getIcon() {
        if (icon == null) {
            icon = ImageUtilities.loadImageIcon("org/mongkie/ui/datatable/resources/nodes.png", false);
        }
        return icon;
    }
    private Icon icon;
