...
public class AddNewColumnUI extends javax.swing.JPanel implements DataAction.UI<GraphDataTable, AddNewColumn>, ItemListener {
    ...
    public boolean apply(boolean ok) {
        if (ok) {
            ...
            Type type = (Type) columnTypeComboBox.getSelectedItem();
            action.setType(type.getType());
            action.setDefaultValue(type.getDefaultValue(initialValueTextField.getText().trim()));
        }
        columnTitleTextField.setText(null);
        initialValueTextField.setText(null);
        columnTypeComboBox.removeItemListener(this);
        ((DefaultComboBoxModel) columnTypeComboBox.getModel()).removeAllElements();
        this.table = null;
        this.action = null;
        return ok;
    }
        ...
        if (validationPanel == null) {
            ...
            validationGroup.add(initialValueTextField,
                    new AbstractValidator<String>(String.class) {
                        ...
                        @Override
                        public void validate(Problems problems, String compName, String model) {
                            Validator<String> v = ((Type) columnTypeComboBox.getSelectedItem()).getValidator();
                            if (v != null) {
    ...
    public void itemStateChanged(ItemEvent e) {
        if (e.getStateChange() == ItemEvent.SELECTED) {
            initialValueTextField.setText(((Type) e.getItem()).getDefaultValue());
        }
    }
    ...
    private static enum Type {
        ...
        BOOLEAN(boolean.class, "Boolean", true, null,
        new ValueParser() {
        ...
        INTEGER(int.class, "Integer", -1, StringValidators.REQUIRE_VALID_INTEGER,
        new ValueParser() {
        ...
        DOUBLE(double.class, "Double", 0.0D, StringValidators.REQUIRE_VALID_NUMBER,
        new ValueParser() {
        ...
        STRING_ARRAY(String.class, "StringArray", "", null,
        new ValueParser() {
        ...
        private Type(Class type, String name, Object defaultValue, Validator<String> validator, ValueParser parser) {
            this.name = name;
            this.type = type;
