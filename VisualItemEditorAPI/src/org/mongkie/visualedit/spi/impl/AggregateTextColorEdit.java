...
public class AggregateTextColorEdit extends AggregateItemEdit<Color> {
    ...
    public Color getDefaultValue() {
        return ColorLib.getColor(Constants.COLOR_DEFAULT_AGGR_TEXT);
    }

    @Override
    public Color getValue(VisualItem group) {
        return Lookup.getDefault().lookup(ColorController.class).getTextColor(group);
    }

    @Override
    public void setValue(VisualItem group, Color c) {
        Lookup.getDefault().lookup(ColorController.class).setTextColor(group, c);
    }
}
