...
public class NodeStrokeColorEdit extends NodeItemEdit<Color> {

    @Override
    public Color getValue(VisualItem n) {
//        return ColorLib.getColor(n.getStrokeColor());
        return Lookup.getDefault().lookup(ColorController.class).getStrokeColor(n);
