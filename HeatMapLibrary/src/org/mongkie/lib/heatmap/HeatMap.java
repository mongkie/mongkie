package org.mongkie.lib.heatmap;
...
public class HeatMap extends JPanel {
    ...
    public Color getColor(int x, int y) {
        return colors[dataColorIndices[x][y]];
    }
    ...
    public void paintComponent(Graphics g) {
        ...
        if (drawYTitle && yAxis != null) {
            ...
            g2d.drawString(yAxis, (height / 2) - 4 * yAxis.length(), -10);
            g2d.rotate(-Math.PI / 2);
        }
        ...
        if (drawXTitle && xAxis != null) {
            g2d.setFont(new Font("Sans", Font.PLAIN, 12));
            g2d.drawString(xAxis, (width / 2) - 4 * xAxis.length(), height - 10);
        }
