...
public class StringUtilities {
    ...
    // Copied from /org/apache/commons/lang3/text/translate/EntityArrays.java
    ...
    private static final Map<Character, String> HTML2ESCAPE_MAP = new HashMap<Character, String>();

    static {
        for (String[] pair : BASIC_ESCAPE) {
            HTML2ESCAPE_MAP.put(pair[0].charAt(0), pair[1]);
        }
//        for (String[] pair : ISO8859_1_ESCAPE) {
//            HTML2ESCAPE_MAP.put(pair[0].charAt(0), pair[1]);
//        }
//        for (String[] pair : HTML40_EXTENDED_ESCAPE) {
//            HTML2ESCAPE_MAP.put(pair[0].charAt(0), pair[1]);
//        }
    }
    ...
    public static String createHtmlTooltip(String title, String s) {
        return createHtmlTooltip(title, s, 10);
    }

    /** HTML-ize a tooltip, splitting long lines */
    public static String createHtmlTooltip(String title, String s, int lineMax) {
