...
public interface Config {
    ...
    public static final int COLOR_DEFAULT_NODE_STROKE = ColorLib.gray(150);
    public static final int COLOR_DEFAULT_NODE_FILL = ColorLib.gray(200);
    public static final int COLOR_DEFAULT_NODE_TEXT = ColorLib.gray(0);
    public static final int COLOR_DEFAULT_EDGE_STROKE = ColorLib.gray(200);
    public static final int COLOR_DEFAULT_EDGE_FILL = ColorLib.gray(200);
