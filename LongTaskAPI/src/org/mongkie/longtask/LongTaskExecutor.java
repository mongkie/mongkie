...
public final class LongTaskExecutor {
     ...
     *
     * @param doInBackground when
     * <code>true</code>, the task will be executed in a separate thread
     ...
     * Creates a new long task executor.
     *
     * @param doInBackground doInBackground when
     * <code>true</code>, the task will be executed in a separate thread
     * @param name           the name of the executor, used to recognize threads by names
     */
     ...
     * <code>null</code>.
     * In this case
     * <code>runnable</code> will be executed normally, but without
     * cancel and progress support.
     *
     * @param task         the task to be executed, can be
     * <code>null</code>.
    ...
    public void execute(LongTask task, Runnable runnable, String taskName) {
        execute(task, runnable, taskName, null);
    }

    /**
     * Cancel the current task. If the task fails to cancel itself and if an
     * <code>interruptDelay</code> has been specified,
     * the task will be <b>interrupted</b> after
     * <code>interruptDelay</code>. Using
     * <code>Thread.interrupt()</code> may cause
     ...
     * @return
     * <
     * code>true</code> if a task is running,
    ...
    private synchronized void started() {
        if (listener != null) {
            listener.taskStarted(runningTask.task);
        }
    }
