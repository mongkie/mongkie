...
public class TableVisualItem extends TableTuple implements VisualItem {
    ...
    public boolean isExpandable() {
        return ((VisualTable) m_table).isExpandable(m_row);
    }
    ...
    public void setExpandable(boolean value) {
        ((VisualTable) m_table).setExpandable(m_row, value);
    }
    ...
    public boolean isOverlapped() {
        return ((VisualTable) m_table).isOverlapped(m_row);
    }

    public boolean isAggregating() {
        return ((VisualTable) m_table).isAggregating(m_row);
    }
    ...
    public void setOverlapped(boolean value) {
        ((VisualTable) m_table).setOverlapped(m_row, value);
    }

    public void setAggregating(boolean value) {
        ((VisualTable) m_table).setAggregating(m_row, value);
    }
