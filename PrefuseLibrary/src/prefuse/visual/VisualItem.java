...
public interface VisualItem extends Tuple {
    ...
    public void setAggregating(boolean value);
    ...
    public static final String EXPANDABLE = PrefuseLib.FIELD_PREFIX + "expandable";
    ...
    public static final String OVERLAPPED = PrefuseLib.FIELD_PREFIX + "overlapped";
    public static final String AGGREGATING = PrefuseLib.FIELD_PREFIX + "aggregating";
    ...
    public static final Schema AGGREGATE_SCHEMA = PrefuseLib.getAggregateItemSchema().lockSchema();
    /** 
    ...
    public static final int IDX_X = SCHEMA.getColumnIndex(X);
    public static final int IDX_Y = SCHEMA.getColumnIndex(Y);
    public static final int IDX_STARTX = SCHEMA.getColumnIndex(STARTX);
    public static final int IDX_STARTY = SCHEMA.getColumnIndex(STARTY);
    public static final int IDX_ENDX = SCHEMA.getColumnIndex(ENDX);
