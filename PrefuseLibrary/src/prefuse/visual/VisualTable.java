...
public class VisualTable extends CascadedTable implements VisualTupleSet {
    ...
    public boolean isExpandable(int row) {
        return getBoolean(row, VisualItem.EXPANDABLE);
    }
    ...
    public void setExpandable(int row, boolean value) {
        setBoolean(row, VisualItem.EXPANDABLE, value);
    }
    ...
    public boolean isOverlapped(int row) {
        return getBoolean(row, VisualItem.OVERLAPPED);
    }

    public boolean isAggregating(int row) {
        return getBoolean(row, VisualItem.AGGREGATING);
    }
    ...
    public void setOverlapped(int row, boolean value) {
        setBoolean(row, VisualItem.OVERLAPPED, value);
    }

    public void setAggregating(int row, boolean value) {
        setBoolean(row, VisualItem.AGGREGATING, value);
    }
