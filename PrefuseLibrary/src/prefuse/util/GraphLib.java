...
public class GraphLib {
    ...
    public static void printDegrees(Graph g, String labelField) {
        Iterator<Node> nodes = g.nodes();
        while (nodes.hasNext()) {
            Node n = nodes.next();
            System.out.println(n.getString(labelField) + " : " + n.getDegree());
        }
    }

    public static void disposeAndClear(Graph g) {
        g.dispose();
        g.getNodeTable().clear();
        g.getEdgeTable().clear();
        g.clear();
    }
