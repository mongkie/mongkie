...
public class PrefuseLib {
    ...
    public static Schema getVisualItemSchema() {
        ...
        s.addColumn(VisualItem.EXPANDABLE, boolean.class, Boolean.TRUE);
        s.addColumn(VisualItem.FIXED, boolean.class, Boolean.FALSE);
        s.addColumn(VisualItem.HIGHLIGHT, boolean.class, Boolean.FALSE);
        s.addColumn(VisualItem.OVERLAPPED, boolean.class, Boolean.FALSE);
        s.addColumn(VisualItem.AGGREGATING, boolean.class, Boolean.FALSE);
        ...
        // stroke
        s.addColumn(VisualItem.STROKE, Stroke.class, StrokeLib.getStroke());
    ...
    public static Schema getAggregateItemSchema() {
        Schema s = getVisualItemSchema();
        s.setDefault(VisualItem.TEXTCOLOR, COLOR_DEFAULT_AGGR_TEXT);
        s.setDefault(VisualItem.FONT, FONT_DEFAULT_AGGRTEXT);
        return s;
    }
    public static final int COLOR_DEFAULT_AGGR_TEXT = ColorLib.gray(0, 128);
    public static final Font FONT_DEFAULT_AGGRTEXT = FontLib.getFont("SansSerif", Font.BOLD, 48);
