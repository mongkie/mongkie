...
//    }
    ...
    public static boolean isModifierPressed(MouseEvent e) {
        return (e.getModifiersEx() & (ALT_DOWN_MASK | CTRL_DOWN_MASK | SHIFT_DOWN_MASK | ALT_GRAPH_DOWN_MASK)) != 0;
    }
    ...
    public static void scrollToCenter(JTable table, int rowIndex, int colIndex) {
