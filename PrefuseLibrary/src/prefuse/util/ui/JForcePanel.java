...
public class JForcePanel extends JPanel {
    ...
    public JForcePanel(ForceSimulator fsim, Visualization v, String layout) {
        this(fsim, new ForcePanelChangeListener(v, layout));
    }

    private JForcePanel(ForceSimulator fsim, ForcePanelChangeListener lstnr) {
        this.fsim = fsim;
        this.setBackground(Color.WHITE);
        this.lstnr = (lstnr == null) ? new ForcePanelChangeListener() : lstnr;
        initUI();
    }
    ...
    private static class ForcePanelChangeListener implements ChangeListener {
        ...
        public ForcePanelChangeListener() {
        }

        public ForcePanelChangeListener(Visualization v, String layout) {
            this.v = v;
            this.layout = layout;
        }
