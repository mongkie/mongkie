...
public class ForceDirectedLayout extends Layout {
    ...
    protected String enforceBoundsGroup;
...
//                }
    ...
    private void updateNodePositions() {
        ...
        while (iter.hasNext()) {
            ...
            if (item.isFixed() || !isEnabled(item)) {
            ...
            if (m_enforceBounds && bounds != null || item.isInGroup(enforceBoundsGroup)) {
    ...
    protected void initSimulator(ForceSimulator fsim) {
        ...
        if (m_edgeGroup != null) {
            ...
            while (iter.hasNext()) {
                ...
                ForceItem f1 = (ForceItem) s.get(FORCEITEM);
                ForceItem f2 = (ForceItem) t.get(FORCEITEM);
    ...
    public void setEnforceBoundsGroup(String group) {
