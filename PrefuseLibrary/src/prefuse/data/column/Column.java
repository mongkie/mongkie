...
public interface Column {
     ...
     *
     * @param readOnly true to ensure the values can not be edited, false
     * otherwise
     */
     ...
     * @throws DataTypeException if this column does not support the integer
     * type
     */
     ...
     * @throws DataTypeException if this column does not support the long type
     */
     ...
     * @throws DataTypeException if this column does not support the float type
     */
     ...
     * @throws DataTypeException if this column does not support the double type
     */
     ...
     * @throws DataTypeException if this column does not support the boolean
     * type
     */
     ...
     * @throws DataTypeException if this column does not support the String type
     */
     ...
     * @throws DataTypeException if this column does not support the Date type
     */
    ...
    /**
     * A text-delimiter to be used concatenating additional values with the
     * existing one in the specified row and column.
     */
