...
public class SplineEditor extends JDialog {
    ...
    public SplineEditor(Frame owner, String title) throws HeadlessException {
    ...
    public Point2D getCurrentControl1() {
        return splineControlPanel.getDisplay().getControl1();
    }

    public Point2D getCurrentControl2() {
        return splineControlPanel.getDisplay().getControl2();
    }
