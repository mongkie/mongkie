package org.mongkie.lib.widgets.file;
 ...
 * @author Tim Boudreau
 */
public class SingleFileChooserBuilder {
     ...
     */
    public SingleFileChooserBuilder(Class type) {
        this(type.getName());
    }
     ...
     */
    public SingleFileChooserBuilder(String dirKey) {
     ...
     * @return this
     */
    public SingleFileChooserBuilder setDirectoriesOnly(boolean val) {
        dirsOnly = val;
        assert !filesOnly : "FilesOnly and DirsOnly are mutually exclusive";
        return this;
    }

    public SingleFileChooserBuilder setFilesOnly(boolean val) {
        filesOnly = val;
     ...
     * @return this
     */
    public SingleFileChooserBuilder setBadgeProvider(BadgeProvider provider) {
     ...
     * @return this
     */
    public SingleFileChooserBuilder setTitle(String val) {
        title = val;
        return this;
    }
     ...
     * @return this
     */
    public SingleFileChooserBuilder setApproveText(String val) {
        approveText = val;
        return this;
    }
     ...
     * @return this
     */
    public SingleFileChooserBuilder setFileFilter(FileFilter filter) {
        this.filter = filter;
        return this;
    }
     ...
     * @return this
     */
    public SingleFileChooserBuilder setDefaultWorkingDirectory(File dir) {
        failoverDir = dir;
        return this;
    }
     ...
     * @return this
     */
    public SingleFileChooserBuilder setFileHiding(boolean fileHiding) {
     ...
     * @return this
     */
    public SingleFileChooserBuilder setControlButtonsAreShown(boolean val) {
     ...
     * @return this
     */
    public SingleFileChooserBuilder setAccessibleDescription(String aDescription) {
     ...
     * @return this
     */
    public SingleFileChooserBuilder forceUseOfDefaultWorkingDirectory(boolean val) {
        this.force = val;
        return this;
    }
     ...
     * @since 7.26.0
     */
    public SingleFileChooserBuilder addFileFilter(FileFilter filter) {
        filters.add(filter);
        return this;
    }
     ...
     * @since 7.26.0
     */
    public SingleFileChooserBuilder setSelectionApprover(SelectionApprover approver) {
    ...
    private static final class SavedDirFileChooser extends JFileChooser {
        ...
        SavedDirFileChooser(String dirKey, File failoverDir, boolean force, SelectionApprover approver) {
            ...
            if (force && failoverDir != null && failoverDir.exists() && failoverDir.isDirectory()) {
                ...
                String path = DONT_STORE_DIRECTORIES ? null
                        : NbPreferences.forModule(SingleFileChooserBuilder.class).get(dirKey, null);
                if (path != null) {
        ...
        public void approveSelection() {
            if (approver != null) {
                boolean approved = approver.approve(getSelectedFile());
                if (approved) {
        ...
        private void saveCurrentDir() {
            ...
            if (!DONT_STORE_DIRECTORIES && dir != null && dir.exists() && dir.isDirectory()) {
                NbPreferences.forModule(SingleFileChooserBuilder.class).put(dirKey, dir.getPath());
            }
        }
    }
