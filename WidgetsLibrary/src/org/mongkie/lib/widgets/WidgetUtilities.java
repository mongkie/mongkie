...
public class WidgetUtilities {
    ...
    public static void setViewportView(JScrollPane scroll, JComponent comp) {
        if (scroll.getViewport().getView() != comp) {
    ...
    public static BufferedImage createComponentScreenshot(final Component component) {
        ...
        final Runnable screenshot = new Runnable() {
        ...
        try {
            if (SwingUtilities.isEventDispatchThread()) {
                ...
                SwingUtilities.invokeAndWait(screenshot);
            }
        } catch (Exception e) {
            return null;
        }
    ...
    public static final Color COMBOBOX_SELECTION_BACKGROUND = UIManager.getColor("ComboBox.selectionBackground") != null
            ? UIManager.getColor("ComboBox.selectionBackground") : new Color(134, 171, 217);
    public static final Color COMBOBOX_SELECTION_FOREGROUND = UIManager.getColor("ComboBox.selectionForeground") != null
            ? UIManager.getColor("ComboBox.selectionForeground") : Color.WHITE;
    public static final Color COMBOBOX_BACKGROUND = UIManager.getColor("ComboBox.background") != null
            ? UIManager.getColor("ComboBox.background") : Color.WHITE;
    public static final Color COMBOBOX_FOREGROUND = UIManager.getColor("ComboBox.foreground") != null
            ? UIManager.getColor("ComboBox.foreground") : Color.BLACK;
}
