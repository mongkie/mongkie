 ...
 */
package org.mongkie.lib.widgets.richtooltip;
    ...
    protected class RichTooltipPanelLayout implements LayoutManager {
        ...
        public Dimension preferredLayoutSize(Container parent) {
            ...
            if (tooltipInfo.getMainImage() != null) {
                height += Math.max(descriptionTextHeight, new JLabel(
                        new ImageIcon(tooltipInfo.getMainImage())).getPreferredSize().height);
            } else {
            ...
            if ((tooltipInfo.getFooterImage() != null)
                ...
                if (tooltipInfo.getFooterImage() != null) {
                    height += Math.max(footerTextHeight, new JLabel(
                            new ImageIcon(tooltipInfo.getFooterImage())).getPreferredSize().height);
                } else {
        ...
        public void layoutContainer(Container parent) {
            ...
            if (tooltipInfo.getMainImage() != null) {
                ...
                mainImageLabel.setBounds(x, y, mainImageLabel.getPreferredSize().width, mainImageLabel.getPreferredSize().height);
            ...
            if ((tooltipInfo.getFooterImage() != null)
                ...
                footerSeparator.setBounds(ins.left, y, parent.getWidth()
                        - ins.left - ins.right, footerSeparator.getPreferredSize().height);
                ...
                if (tooltipInfo.getFooterImage() != null) {
                    ...
                    footerImageLabel.setBounds(x, y, footerImageLabel.getPreferredSize().width, footerImageLabel.getPreferredSize().height);
