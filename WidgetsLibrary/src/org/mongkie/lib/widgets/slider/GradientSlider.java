 ...
 */
package org.mongkie.lib.widgets.slider;
 ...
 * By default this is {@link GradientSliderUI}.
 */
//Author Jeremy Wood
public class GradientSlider extends MultiThumbSlider {
    ...
    static {
        if (UIManager.getString("GradientSliderUI") == null) {
            UIManager.put("GradientSliderUI", "org.mongkie.lib.widgets.slider.GradientSliderUI");
        }
    }
        ...
        try {
            ...
            for (int a = 0; a < constructors.length; a++) {
                ...
                if (types.length == 1 && types[0].equals(GradientSlider.class)) {
                    ComponentUI compUI = (ComponentUI) constructors[a].newInstance(new Object[]{this});
                    setUI(compUI);
                    return;
                }
            }
            ...
            throw new RuntimeException("The class \"" + name + "\" could not be constructed.", t);
        }
    }
}
