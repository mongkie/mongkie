 ...
 */
@ServiceProvider(service = Exporter.OptionUI.class)
public class ExporterOptionUICSV extends javax.swing.JPanel implements Exporter.OptionUI<ExporterCSV> {

    private ExporterCSV exporter;

    /** Creates new form ExporterOptionUICSV */
    public ExporterOptionUICSV() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        printHeaderCheckBox.setText(org.openide.util.NbBundle.getMessage(ExporterOptionUICSV.class, "ExporterOptionUICSV.printHeaderCheckBox.text")); // NOI18N
        printHeaderCheckBox.setFocusPainted(false);

        selectTableLabel.setIcon(new javax.swing.ImageIcon(getClass().getResource("/org/mongkie/exporter/plugins/resources/light-bulb.png"))); // NOI18N
        selectTableLabel.setText(org.openide.util.NbBundle.getMessage(ExporterOptionUICSV.class, "ExporterOptionUICSV.selectTableLabel.text")); // NOI18N

        tableButtonGroup.add(nodeRadioButton);
        nodeRadioButton.setSelected(true);
        nodeRadioButton.setText(org.openide.util.NbBundle.getMessage(ExporterOptionUICSV.class, "ExporterOptionUICSV.nodeRadioButton.text")); // NOI18N
        nodeRadioButton.setFocusPainted(false);

        tableButtonGroup.add(edgeRadioButton);
        edgeRadioButton.setText(org.openide.util.NbBundle.getMessage(ExporterOptionUICSV.class, "ExporterOptionUICSV.edgeRadioButton.text")); // NOI18N
        edgeRadioButton.setFocusPainted(false);

        optionLabel.setIcon(new javax.swing.ImageIcon(getClass().getResource("/org/mongkie/exporter/plugins/resources/gear.png"))); // NOI18N
        optionLabel.setText(org.openide.util.NbBundle.getMessage(ExporterOptionUICSV.class, "ExporterOptionUICSV.optionLabel.text")); // NOI18N
    ...
    @Override
    public void setup(ExporterCSV exporter) {
