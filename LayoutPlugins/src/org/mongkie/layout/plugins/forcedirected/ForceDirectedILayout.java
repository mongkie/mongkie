 ...
 * @author yjjang
 */
public class ForceDirectedILayout extends PrefuseLayout<ForceDirectedILayout, ForceDirectedLayout> {
    ...
    ForceDirectedILayout(LayoutBuilder<ForceDirectedILayout> builder) {
        super(builder);
    }
