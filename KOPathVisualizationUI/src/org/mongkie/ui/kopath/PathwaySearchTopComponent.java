...
public final class PathwaySearchTopComponent extends TopComponent implements ExplorerManager.Provider {
    ...
    public PathwaySearchTopComponent() {
        ...
        searchInputPanel.add(new JScrollPane(tpc), BorderLayout.CENTER);
    ...
    private void initComponents() {
        ...
        searchResultPanel.setBorder(javax.swing.BorderFactory.createEtchedBorder());
    ...
    /**
     * Obtain the PathwaySearchTopComponent instance. Never call {@link #getDefault} directly!
     */
